...
package io.github.coolys.security.ssl;
 ...
 * <p>
 * Please note that when using Coolybot, you can use the `server.ssl.ciphers` property that is commented out
...
public class UndertowSSLConfiguration {
    ...
    public UndertowSSLConfiguration(UndertowServletWebServerFactory undertowServletWebServerFactory,
        CoolybotProperties jHipsterProperties) {
