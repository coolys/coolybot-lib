...
public class CoolybotProperties {
    ...
    public static class Http {
         ...
         */
        private boolean useUndertowUserCipherSuitesOrder = CoolybotDefaults.Http.useUndertowUserCipherSuitesOrder;

        /**
         * HTTP version, must be "V_1_1" (for HTTP/1.1) or V_2_0 (for (HTTP/2)
         */
        public Version version = CoolybotDefaults.Http.version;
    ...
    public static class Gateway {
        ...
        private Map<String, List<String>> authorizedMicroservicesEndpoints = CoolybotDefaults.Gateway
