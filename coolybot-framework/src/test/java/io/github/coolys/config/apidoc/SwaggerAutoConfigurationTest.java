...
import io.github.coolys.config.CoolybotProperties.Swagger;
...
public class SwaggerAutoConfigurationTest {
    ...
    public void setup() {
        ...
        final CoolybotProperties jHipsterProperties = new CoolybotProperties();
    ...
    public void testSwaggerSpringfoxApiDocket() {
        List<SwaggerCustomizer> customizers = Lists.newArrayList(new CoolybotSwaggerCustomizer(properties));
